...
\begin{table}
	\begin{tabular}{|l|c|c|c|c|}
		...
		System & Type & Attribute  & Type & Attribute\\
		\hline
		\hline
...
In part, this is from a more sophisticated modeling of syntactic ambiguity:
	e.g., \tp{the past few weeks} has a clause \tp{the past} -- which
	should be parsed as \te{PAST} -- yet the system correctly tags both
	elements as \ty{Nil} and returns an approximate duration \te{~2 weeks}.
