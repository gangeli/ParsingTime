...
The input to the Gaussian uses a function $\delta_{s,t}$:
...
Unlike many aspects of language  -- which are often idiomatic or not compositional
...
Decomposing the example, we can construct a meaning by 
	...
	to create our intended expression.
...
That is, we are applying a rule-to-rule translation 
