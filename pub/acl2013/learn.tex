...
Features 11 and 13 in \reffig{features} (b) are examples of such features.
...
In the second case -- absorbing \ty{Nil}-tagged spans --
  ...
  (e.g., features 7--9 in \reffig{features} (b)).
...
To mediate this, an indicator feature is extracted
  ...
  valid.
This is illustrated in \reffig{features} (b) by feature 14.
