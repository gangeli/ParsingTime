...
% -- Intro
We compare against previous work parsing English and Spanish temporal
...
% -- Outline
We describe the \tempeval\ dataset in \refsec{tempeval} and experimental
  results in \refsec{scores}.

% -----
% DATASET
% -----
\Subsection{tempeval}{Tempeval Datasets}
% -- Intro
...
Note that this is a restrictive metric; for instance, \tp{three months} and
  \tp{ninety days} have the same interpretation, but
