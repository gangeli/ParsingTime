#!/usr/bin/perl -w
#!/usr/bin/perl -w -I/projects/TIDES/GVW/bin
# driver for tagging time expressions
# this driver is aimed at TDT data
# Original Author:         George Wilson  - gwilson@mitre.org
# GUTime Contact: Jon Phillips - jbp24@georgetown.edu 
...
while((defined $ARGV[0]) && ($ARGV[0] =~ /^-/)) {
    ...
    elsif($flag =~ /\A-EURO\Z/o)     { $EuroTime = 1; }
    else {
...
sub Usage() {
    ...
    print "Usage:   TimeTag.pl [-h -FD -TH -EURO -Dn -HLn] files\n";
    print "                                  n is a number\n";
    ...
    print "         EURO = Use European-style date formats\n";
